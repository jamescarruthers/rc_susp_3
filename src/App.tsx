  ...
  return (
    <div className="h-full w-full flex flex-col">
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <aside className="w-72 shrink-0 border-l border-neutral-800 bg-neutral-950 text-xs font-mono p-3 overflow-y-auto">
          <h2 className="text-neutral-300 font-semibold mb-2">Telemetry</h2>
          <p className="text-neutral-500">uPlot charts mount here at milestone 6.</p>
        </aside>
      </div>
    </div>
  );
